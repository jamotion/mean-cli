...
function buildDirectoryStructure() {
  ...
  mkdir(path + '/public/directives', function() {
    write(path + '/public/directives/' + name + '.js', readTemplate('client/directive.js'));
    write(path + '/public/directives/' + name + '.html', readTemplate('client/directive.html'));
  });
  ...
  mkdir(path + '/public/tests', function() {
    mkdir(path + '/public/tests/directives', function() {
      write(path + '/public/tests/directives/' + name + '-specs.js', readTemplate('client/directive_test.js'));
    });
    mkdir(path + '/public/tests/controllers', function() {
      write(path + '/public/tests/controllers/' + name + '-specs.js', readTemplate('client/controller_test.js'));
    });
  });
  mkdir(path + '/server');
