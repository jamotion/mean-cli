...
//  var source = (options.git ? 'git@github.com:linnovate/mean.git' : 'https://github.com/linnovate/mean.git');
  var source = (options.git ? 'git@github.com:jamotion/mean.git' : 'https://github.com/jamotion/mean.git');
    ...
    npm.load({
      ...
      fs.readdir(rootDir + '/' + source, function(err, files) {
        ...
        files.forEach(function(file) {
          var where = rootDir + '/' + source + '/' + file;
          npm.commands.install(where, [where], function(err) {
            if (err) {
              console.log(chalk.red('Error: npm install failed'));
              return console.error(err);
            } else {
...
exports.install = function(module, options) {
  requiresRoot(function() {
    ...
    var source = 'https://github.com/jamotion/' + module + '/tarball/' + options.branch;
